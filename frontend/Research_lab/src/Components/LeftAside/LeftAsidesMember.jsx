            ...
            <div key={section.key} className="relative mb-8">
              ...
              <div className="ml-6">
                ...
                <button
                  ...
                  className={`text-lg font-bold mb-3 transition-all hover:text-primary ${level === section.key ? 'text-primary scale-105' : 'text-base-content'
                    }`}
                >
                  {section.label}
                </button>
                  ...
                  <div className="relative ml-4 space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <NavLink
                        ...
                        className={({ isActive }) =>
                          `block ml-4 py-1 text-lg transition-all ${isActive
