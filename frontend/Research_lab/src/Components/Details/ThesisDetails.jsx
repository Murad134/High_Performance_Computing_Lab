...
import { ArrowLeft, Calendar, User, BookOpen, Tag, FileText, CheckCircle, Clock, GraduationCap, Building, Hash } from "lucide-react";
...
const ThesisDetails = () => {
    ...
    const formatAbstract = (description) => {
    ...
    const abstractParagraphs = formatAbstract(normalized.description);
